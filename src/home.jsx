        ...
        <div className="row">
          ...
          <div className="col-8 text-justify">
            <p>
              ...
              el{" "}
              <a href="https://lalibertadcr.org/" target="_blank">
                Parque La Libertad
              </a>{" "}
              en las comunidades aledañas, hemos desarrollado una plataforma web
              que presenta los resultados de un detallado levantamiento de nube
              de puntos del parque, utilizando tecnologías avanzadas de
              visualización y modelado en 3D. Este proyecto no solo se centra en
              la representación visual, sino en la creación de un puente entre
              los datos técnicos y las comunidades que interactúan con el
              territorio.
            </p>
            <p>
