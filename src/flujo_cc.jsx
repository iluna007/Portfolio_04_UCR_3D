                    ...
                    <div className="row">
                      ...
                      <div className="col-8 text-justify">
                        <p>
                          ...
                          `.las` o `.laz`. Ve a `Archivo {">"} Abrir`,
                          selecciona el archivo y asegúrate de que la nube de
                          puntos se visualiza correctamente.
                    ...
                    <div className="row">
                      ...
                      <div className="col-8 text-justify">
                        <p>
                          ...
                          `Edit {">"} Mesh {">"} Delaunay 2.5D (Best fitting
                          plane)` para generar un mesh. Simplifica el mesh si es
